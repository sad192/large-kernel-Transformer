# 测试
# 开发时间：2022/9/28 14:21
# from model import common
import torch
import torch.nn as nn
from positions import PositionEmbeddingLearned, PositionEmbeddingSine
...
class MLABlock(nn.Module):
    def __init__(
        ...
        self.dim = dim
        self.patch_embed = PatchEmbed(img_size=64, patch_size=2, in_chans=n_feat, embed_dim=dim)
