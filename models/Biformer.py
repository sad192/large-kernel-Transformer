...
######## topks=[1, 4, 16, -2] kv_downsample_mode='identity' ada_avgpool kv_downsample_ratios=[4, 2, 1, 1] kv_downsample_kernels=[4, 2, 1, 1]
class Block(nn.Module):
    def __init__(self, dim, drop_path=0., layer_scale_init_value=-1,
                 num_heads=8, n_win=8, qk_dim=None, qk_scale=None,
                 kv_per_win=-1, kv_downsample_ratio=4, kv_downsample_kernel=4, kv_downsample_mode='identity',
                 topk=8, param_attention="qkvo", param_routing=False, diff_routing=False, soft_routing=False,
...
if __name__ == '__main__':
    input = torch.rand(1, 96, 256, 256)
    model = BiLevelRoutingAttention(dim=96,topk=16)
