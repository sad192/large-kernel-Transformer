...
from swinUnetSR.restormer_swin import ParaHybridStage_back,ParaHybridStage,PPM
...
class mySRNet(nn.Module):
    def __init__(self, inc=3,outc=3,upscale=2,num_feat = 64,embed_dim=64,f_groups=4,f_stages=2,Lblocks=6,layers=6 ,img_size=64,upsampler='pixelshuffle', img_range=1.,norm_layer=GroupNorm):
